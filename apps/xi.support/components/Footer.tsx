...
const renderSection = (section: Section) => (
  <div key={section.title} className="xs:gap-6 flex flex-col gap-4">
    <p className="text-gray-60 text-m-base xs:text-lg mb-0 mt-0">{section.title}</p>
    <ul className="flex flex-col gap-6 mb-0 mt-0 pl-0">
      {section.links.map((link, index) => (
        <li key={index} className="mb-0 mt-0 list-none">
          <Link
            className="no-underline text-m-base text-gray-0 hover:text-gray-0 hover:decoration-gray-0"
            variant="hover"
            href={link.link}
            size="l"
          >
