  ...
  <div className="flex justify-center h-full bg-gray-100 px-4 sm:px-8 xl:px-[160px] w-full z-10">
    <div className="flex gap-[145px] w-full max-w-[1920px]">
      <div className="hidden xl:block">
        <div className="w-[400px] h-[calc(400px/2)] rounded-[0_0_50%_50%_/_0_0_100%_100%] bg-gray-90" />
        <div className="size-[400px] rounded-full bg-gray-90" />
        <div className="w-[400px] h-[calc(400px/2)] rounded-[0_0_50%_50%_/_0_0_100%_100%] bg-gray-90 rotate-180" />
      </div>
