    ...
    >
      <div className="h-full w-full grid grid-cols-1 grid-rows-3 gap-[10px] sm:grid-cols-3 sm:grid-rows-2 sm:gap-6 items-stretch sm:place-content-center">
        ...
        <Sticker
          ...
          bgColor="green"
        >
          <div className="flex flex-col items-start justify-center sm:justify-start gap-8">
            <div>Ход опыта:</div>
        ...
        <Sticker
          ...
          bgColor="yellow"
        >
          <div className="flex flex-col items-start justify-center sm:justify-start gap-6">
