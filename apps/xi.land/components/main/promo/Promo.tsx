...
export const Promo = () => (
  <section className="p-4 xs:p-8 md:py-32 lg:py-48 2xl:py-64 xl:px-24 relative">
    <div className="rounded-[32px] sm:rounded-[64px] justify-between bg-gray-100 p-8 h-[477px] xl:p-16 flex max-sm:bg-none bg-[center_top_8rem] md:bg-[right_top_2rem] 2xl:bg-[right_2rem_top_-4rem] bg-auto bg-[url('/assets/main/promo/bg.svg')] bg-no-repeat ">
