...
export const Faq = () => {
  return (
    <section className="relative  w-full px-4 py-8 sm:px-[32px] sm:pt-[48px] sm:pb-[56px] lg:px-[160px] lg:pb-[246px] lg:pt-[80px] flex flex-col gap-[52px] lg:gap-[168px] lg:grid lg:grid-cols-[minmax(400px,_488px)_1fr] ">
