      ...
      <div className="row-span-2 xs:grid-rows-4 sm:grid-rows-2 grid sm:grid-cols-2 gap-4 xs:gap-8 2xl:gap-16">
        {descriptionBlocks.map((item, index) => (
          <motion.div
            ...
            key={item.image}
            className="flex flex-col sm:px-4 md:px-2 lg:px-4 xs:gap-2 sm:aspect-square justify-between xs:py-8 xs:bg-violet-20 xs:rounded-[32px] sm:w-auto sm:h-auto 2xl:p-8"
          >
