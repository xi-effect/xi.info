...
export const Text = ({
  ...
  <section
    data-theme={theme}
    className={cn(
      'py-[32px] px-[16px] xs:py-[48px] xs:px-[32px] md:py-[64px] md:px-[160px] relative flex flex-col items-center justify-center z-0 bg-gray-0 dark:bg-gray-100 w-full transition-all duration-700 ease-in-out',
      className,
    )}
  >
