...
export const Hero = () => {
  ...
  return (
    <section
      data-theme="white"
      className="relative flex flex-col items-center justify-center z-0 bg-gray-0 dark:bg-gray-100 h-100dvh min-h-100dvh w-full pt-36 px-6 pb-12 transition-all duration-700 ease-in-out"
    >
