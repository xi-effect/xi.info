...
const AboutChangeWorld = () => {
  return (
    <div className="py-8 px-4 2xl:py-16 2xl:px-24 flex flex-col w-screen">
      <h2 className="text-[24px] md:text-[32px] 2xl:text-[64px] font-medium ml-4 md:ml-8 2xl:ml-16">
        Меняйте мир — мы поможем
      </h2>
      <div className="flex flex-col 2xl:flex-row gap-4 md:gap-8 mt-4 md:mt-8">
        <motion.div
          initial={{ y: -10, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          transition={{ delay: 0.5, duration: 1 }}
          viewport={{ once: true }}
          className={`${cardsStyles} flex-col 2xl:flex-row w-full 2xl:w-[55%] min-h-[442px] md:min-h-[592px] 2xl:min-h-[546px]`}
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className={`${cardsStyles} flex-col w-full 2xl:w-[45%] min-h-[368px] md:min-h-[468px] 2xl:min-h-[546px]`}
        >
          <div className="w-full flex flex-col">
            <span className="text-[20px] md:text-[32px] 2xl:text-[56px] font-medium text-gray-100">
      ...
      <div className="flex flex-col 2xl:flex-row gap-4 md:gap-8 mt-4 md:mt-8">
        <motion.div
          ...
          transition={{ delay: 0.5, duration: 1 }}
          viewport={{ once: true }}
          className={`${cardsStyles} flex-col w-full 2xl:w-[45%] min-h-[246px] md:min-h-[422px] 2xl:min-h-[500px]`}
        >
          <div className="w-full flex flex-col">
            <span className="text-[20px] md:text-[32px] 2xl:text-[56px] font-medium text-gray-100">
              Решим любой вопрос
        ...
        <motion.div
          ...
          transition={{ delay: 1, duration: 1 }}
          viewport={{ once: true }}
          className={`${cardsStyles} flex-col w-full 2xl:w-[55%] min-h-[216px] md:min-h-[376px] 2xl:min-h-[500px]`}
        >
          <div className="w-full flex flex-col">
            <span className="text-[20px] md:text-[32px] 2xl:text-[56px] font-medium text-gray-100">
