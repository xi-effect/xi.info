...
const AboutAnnounce = () => {
  return (
    <div className="flex flex-col justify-start items-start py-8 px-4 sm:p-8 xl:p-[160px] xl:pb-20 w-full bg-gray-5 z-10">
      ...
      <h2 className="mt-4 text-[24px] sm:text-[32px] 2xl:text-[64px] text-gray-70 font-medium leading-[130%]">
        А кроме того объявления и расписание. <br /> Все в одном месте.
      </h2>
      <h3 className="mt-4 text-[14px] sm:text-[20px] 2xl:text-[40px] text-gray-70 leading-[130%]">
