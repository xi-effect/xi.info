...
const tabs = [
  ...
  },
  {
    ...
    content:
      'Задавайте задания в удобном для вас формате, проверяйте загруженные студентами файлы или прикрипленные ими документы из вcтроенного редактора',
    link: '',
  ...
  },
  {
    ...
    content:
      'Свободно публикуйте любую необходимую информацию в тектовом формате, прикрепляйте фото и видео, вставляйте цитаты и важные заметки. Все для вашей удобной работы',
    link: '',
...
const AboutAllIn = () => {
  ...
  return (
    <motion.div
      ...
      className="py-8 px-4 2xl:py-16 2xl:px-24 flex flex-col w-screen"
    >
      ...
      <Tabs.Root onValueChange={handleChange} defaultValue="Тесты">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className={`w-full h-full min-h-[471px] md:min-h-[678px] flex flex-col 2xl:flex-row p-4 md:p-8 2xl:p-16 rounded-[8px] md:rounded-[16px] 2xl:rounded-[64px] ${selectedTab.color}`}
          >
