  ...
  return (
    <footer>
      <div className="my-16 p-16 bg-gray-10 rounded-[32px] relative">
        ...
        <button className="bg-brand-80 text-gray-0 px-16 py-6 rounded-3xl t-l h-[112px] w-[507px]">
          Отправить резюме
        </button>
      ...
      <div className="p-16 flex items-center justify-between">
        ...
        <span className="t-xl text-gray-60"> &copy; xieffect.ru {new Date().getFullYear()}</span>
      </div>
    </footer>
  );
};
