  ...
  <section className="mb-4 p-4 sm:p-8 sm:mb-16 bg-gray-10 rounded-[16px] sm:rounded-[24px] 2xl:rounded-[32px] 2xl:p-[48px]">
    ...
    <div className="flex flex-col lg:flex-row mb-[32px] 2xl:mb-[48px]">
      <Image
        ...
        className="w-full object-cover rounded-[16px] mb-4 lg:mb-0 h-[200px] sm:h-[300px] 2xl:h-[400px] lg:mr-[32px] lg:basis-[49%] lg:w-[49%]"
      />
    ...
    <div className="flex flex-col lg:flex-row mb-[32px] 2xl:mb-[48px]">
      <Image
        ...
        height={1270}
        quality={100}
        className="lg:order-2 w-full object-cover rounded-[16px] sm:rounded-[24px] mb-4 lg:mb-0 h-[200px] sm:h-[300px] 2xl:h-[400px] lg:basis-[49%]"
    ...
    <div className="flex flex-col lg:flex-row">
      <Image
        ...
        height={1278}
        quality={100}
        className="w-full object-cover rounded-[16px] sm:rounded-[24px] mb-4 lg:mb-0 h-[200px] sm:h-[300px] 2xl:h-[400px] lg:mr-[32px] lg:basis-[49%]"
