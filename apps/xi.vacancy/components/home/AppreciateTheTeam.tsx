  ...
  <section className="mb-4 p-4 sm:p-8 sm:mb-16 bg-gray-10 rounded-[16px] sm:rounded-[24px] 2xl:rounded-[32px] 2xl:p-[48px]">
    ...
    <div className="flex flex-col xl:flex-row mb-[32px] 2xl:mb-[48px]">
      <Image
        ...
        className="w-full object-cover rounded-[16px] mb-4 xl:mb-0 h-[200px] sm:h-[300px] 2xl:h-[400px] xl:mr-[32px] 2xl:basis-[49%]"
      />
    ...
    <div className="flex flex-col xl:flex-row mb-[32px] 2xl:mb-[48px]">
      <Image
        ...
        height={1270}
        quality={100}
        className="xl:order-2 w-full object-cover rounded-[16px] sm:rounded-[24px] mb-4 xl:mb-0 h-[200px] sm:h-[300px] 2xl:h-[400px] 2xl:basis-[49%]"
    ...
    <div className="flex flex-col xl:flex-row">
      <Image
        ...
        height={1278}
        quality={100}
        className="w-full object-cover rounded-[16px] sm:rounded-[24px] mb-4 xl:mb-0 h-[200px] sm:h-[300px] 2xl:h-[400px] xl:mr-[32px] 2xl:basis-[49%]"
