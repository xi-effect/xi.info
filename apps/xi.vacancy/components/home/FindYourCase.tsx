...
const FindYourCase = () => {
  ...
  return (
    <section className="p-[16px] sm:p-8 sm:mb-8 2xl:mb-[110px] 2xl:p-[48px]">
      <Memoji
        wrapperClassName="mb-[16px] sm:mb-8 2xl:mb-[47px]"
      ...
      <SendResumeButton className=" bg-transparent text-[16px] text-gray-100 rounded-[8px] 2xl:rounded-[12px] w-full py-[10px] border-2 border-gray-30 sm:w-[46%] sm:max-w-[302px] 2xl:text-[27px] 2xl:py-[16px] 2xl:h-[72px]" />
    </section>
  );
};
